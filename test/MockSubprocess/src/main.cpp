...
int main(int argc, char* argv[]) {
    ...
    if (
        ...
        std::ofstream report((SystemUtils::File::GetExeParentDirectory() + "/TestArea/handles").c_str());
        ...
        SystemUtils::File handlesReport(SystemUtils::File::GetExeParentDirectory() + "/TestArea/handles");
    ...
    const std::string testFilePath = SystemUtils::File::GetExeParentDirectory() + "/TestArea/foo.txt";
