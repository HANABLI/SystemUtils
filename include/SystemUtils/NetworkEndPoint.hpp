...
namespace SystemUtils
{
    ...
    public:
         ...
         */
        typedef std::function<void(std::shared_ptr<NetworkConnection> networkConnection)>
    ...
    public:
        ...
        DiagnosticsSender::UnsubscribeDelegate SubscribeToDiagnostics(
            DiagnosticsSender::DiagnosticMessageDelegate delegate, size_t minLevel = 0);
         ...
         */
        bool Open(NetworkConnectionDelegate newConnectionDelegate,
                  PacketReceivedDelegate packetReceivedDelegate, Mode mode, uint32_t localAddress,
                  uint32_t groupAddress, uint16_t port);
