...
namespace SystemUtils
{
    ...
    public:
         ...
         */
        typedef std::function<void(std::string senderName, size_t Level, std::string message)>
    ...
    public:
         ...
         */
        UnsubscribeDelegate SubscribeToDiagnostics(DiagnosticMessageDelegate delegate,
                                                   size_t minLevel = 0);
