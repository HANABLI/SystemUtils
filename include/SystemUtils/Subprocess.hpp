#ifndef SYSTEM_UTILS_SUBPROCESS_HPP
#define SYSTEM_UTILS_SUBPROCESS_HPP

/**
 * @file Subprocess.hpp
 *
 * This module declares the SystemUtils::Subprocess class.
 *
 * © 2024 by Hatem Nabli
 */
...
{
    /**
     * This class represent a child process started by the current process
    ...
    public:
         ...
         *       the subprocess can open use to communicate
         ...
         */
        unsigned int StartChild(std::string program, const std::vector<std::string>& args,
         ...
         */
        static unsigned int StartDetached(std::string program,
         ...
         * can know when child process exits or crashes.
         *
         * @param[in, out] args
         ...
         *      front are removed (see not in StartChild()).
         *
         * @return
        ...
        /**
         * This function gathers informations about all the process currently
        ...
        /**
         * This function kills the process with given identifier.
         *
         * @param[in] id
...
#endif /* SYSTEM_UTILS_SUBPROCESS_HPP */