...
namespace SystemUtils
{
    ...
    struct DirectoryMonitor::Impl
    {
         ...
         * called whnever a change is detected to the monitored directory.
         */
    ...
    DirectoryMonitor::DirectoryMonitor() : impl_(new Impl()) {}
    ...
    bool DirectoryMonitor::Start(Callback callback, const std::string& path) {
        ...
        impl_->changeEvent = FindFirstChangeNotificationA(path.c_str(), FALSE,
